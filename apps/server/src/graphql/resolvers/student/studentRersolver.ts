  ...
  Mutation: {
    updateStudentBasicInfo: async (_, { input, ID }, ctx) => {
      try {
        ...
        await recordTrail(employee_id, trailMessage, "MANAGE_STUDENT_INFO");
        return savedStudent;
      } catch (error) {
        throw new GraphQLError(error, {
          extensions: {
    ...
    addStudent: async (_, { input }, ctx) => {
      try {
        ...
        await recordTrail(employee_id, trailMessage, "ADDED_STUDENT");
        return savedStudent;
      } catch (error) {
        throw new GraphQLError(error, {
          extensions: {
    ...
    enrollStudent: async (_, { input }, ctx) => {
      try {
        ...
        await recordTrail(employee_id, trailMessage, "ENROLL_STUDENT");
        return reselectStudent;
      } catch (error) {
        throw new GraphQLError(error, {
          extensions: {
